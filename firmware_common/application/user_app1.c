...
/* Char buffer */
static u8 UserApp1_au8UserInputBuffer[U16_USER_INPUT_BUFFER_SIZE];
...
static void UserApp1SM_Idle(void)
{
  ...
  if(WasButtonPressed(BUTTON1))
  {
    ...
    /* read the buffer and print the contents if buffer is NOT empty*/
